  ...
  return (
    <Card className="overflow-hidden">
      <div className="border-b border-slate-100 px-4 py-3">
        <h2 className="text-fin-lg font-semibold text-slate-900">{t('overview.byModule')}</h2>
      </div>
      <div className="overflow-x-auto">
        <table className="w-full border-collapse text-fin-md">
          <thead className="bg-slate-50">
            <tr className="border-b border-slate-200 text-left">
              <th className="px-4 py-2.5 text-fin-xs font-semibold uppercase tracking-wide text-slate-500">
                {t('overview.module')}
              </th>
              <th className="px-4 py-2.5 text-right text-fin-xs font-semibold uppercase tracking-wide text-slate-500">

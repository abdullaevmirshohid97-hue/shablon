...
export function LedgerTable({
  ...
  return (
    <Card className="flex flex-col overflow-hidden">
      <div className="no-print flex items-center justify-end gap-2 border-b border-slate-100 px-4 py-3">
        <Button
          type="button"
          variant="secondary"
          size="sm"
          onClick={() =>
            transactions && exportLedgerToExcel(counterpartyName, transactions, locale)
          }

...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 17, fontWeight: '700', color: '#0f172a' },
  nav: { flex: 1 },
  section: {
    marginTop: 14,
    marginBottom: 4,
  ...
  itemText: { fontSize: 15, color: '#334155', fontWeight: '500' },
  itemTextActive: { color: '#3730a3', fontWeight: '700' },
  footer: { borderTopWidth: 1, borderTopColor: '#e2e8f0', paddingTop: 12, paddingHorizontal: 6 },
  orgName: { fontSize: 12, fontWeight: '700', color: '#334155' },

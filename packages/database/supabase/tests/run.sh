...
SUITES=(10_roles_audit.sql 20_reversal_periods.sql 30_ledger_currency.sql 40_reporting.sql 50_finance_pin.sql 60_sklad.sql 70_sklad_invoices.sql)
NEEDS_FIXTURE=(no yes yes yes yes yes yes)
